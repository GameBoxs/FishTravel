...
const SingleGamePage = () => {
    ...
    const NAVER_API_KEY = `https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=4vgyzjsnlj&submodules=panorama`;
    ...
    return (
        <React.Fragment>
            {
                showMap ? (locationMod === 'domestic' ? <SingleDomestic /> : <SingleDomestic />) : null
            }
        </React.Fragment>
    )
}
